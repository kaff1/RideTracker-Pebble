...
#ifndef RideTracker_RideTracker_h
#define RideTracker_RideTracker_h
...
void message_received(DictionaryIterator *iterator, void *context);
void updateDistance(int metres);
void in_received_handler(DictionaryIterator *iter, void *context);
void sendStartCommand(bool);
